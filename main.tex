\documentclass[10pt,a4paper, footheight=1mm]{scrreprt}
...
Hierbei gibt $\sigma = \varphi_\mathcal{A}(g)$ an, welche
Kante an der jeweiligen Stelle abgefragt wird,
d.h. $\sigma(k)=i$ bedeutet, dass an $k$-ter
Stelle die Kante $i$ abgefragt wird.
...
$g\in \mathbb{F}_2^m$ und Kantenindizes $1\leq i \leq m$
...
\end{equation}
Hierbei ist $e_i$ der $i$-te kanonische Einheitsvektor
