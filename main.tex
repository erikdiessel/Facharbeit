...
monotone Eigenschaft einfacher zu beschreiben. Dies
wird sich in Beweisen später nützlich erweisen.\\
...
$$ p_\mathcal{A}: \{ \mathcal{A} \ {\rm deterministisch} \ | \
...
\end{definition}
Analog zum deterministischen Fall kpnnen wir nun die
...
\subsection{Einfache untere Schranken für die Abfragekomplexität}
...
$$ C_R(p_\mathcal{A}, H) =
\sum_\mathcal{A} p_\mathcal{A}(\mathcal{A}) \cdot C(\mathcal{A}, H) \geq
\sum_\mathcal{A} p_\mathcal{A}(\mathcal{A}) \cdot |E(H)| =
|E(H)| $$
Mit Definition \ref{def:randComplProp} erhalten wir dann
$$ C_R(P_n) = \min_{p_\mathcal{A}}\ C(p_\mathcal{A}) \geq |E(H)|$$
\end{proof}
