...
der konstruierte Graph keinen minimalen Graphen
...
wenn es zwei benachbarte Ecken $u,v\in G$ gibt, sodass
ein Graph $G'$, der aus $G$ entsteht, indem man die
Kante $uv\in E(G)$ löscht und dann beliebig viele Kopien
von $u$ und $v$ einfügt, nie den Graphen $G$ als
Subgraphen enthält.
\end{definition}
...
% Zeige, dass der Ansatz Größe Minimaler / Kantenmaximaler Graph
% nicht allgemeingültig funktionieren kann,
% mit dem Beispiel: 
